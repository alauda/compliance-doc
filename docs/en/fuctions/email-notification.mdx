...
- Prepare Email Server configurations:
  - **`global` cluster**: You need to configure the email server by this document  <ExternalSiteLink name="acp" href="/observability/monitor/functions/manage_notifcation.html#email-server" children="Email Server Configuration for `global` cluster" />.
